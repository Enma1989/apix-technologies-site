...
const credibilityItems = [
    {
        ...
        desc: {
            pt: "Entregamos topologias detalhadas e inventários completos. Sua TI nunca mais será uma 'caixa preta'.",
            en: "We deliver detailed topologies and complete inventories. Your IT will never be a 'black box' again.",
            es: "Entregamos topologías detalladas e inventarios completos. Su TI nunca más será una 'caja negra'."
        }
    },
    {
