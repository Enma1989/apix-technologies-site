...
export default async function OperacaoSuportePage({ params }: PageProps) {
    ...
    return (
        <main className="min-h-screen bg-premium-dark">
                    ...
                    <div className="max-w-2xl">
                        ...
                        <div className="space-y-6">
                            <h1 className="text-4xl md:text-5xl lg:text-7xl font-outfit font-bold mb-8 tracking-tight leading-tight text-white text-shadow-premium uppercase">
                                OPERAÇÃO &<br />
                                SUPORTE <span className="text-apix-yellow drop-shadow-[0_0_20px_rgba(255,210,63,0.4)]">MaaS™</span>
                            </h1>
            ...
            {/* SEÇÃO 3 – MaaS™ NA PRÁTICA (FUNDO ESCURO PREMIUM) */}
                ...
                <div className="container-premium relative z-10 max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-outfit font-bold text-white uppercase tracking-tight leading-none mb-6">
                            MaaS™ na prática: <span className="text-secondary drop-shadow-[0_0_15px_rgba(255,210,63,0.3)]">Como funciona a Operação sob modelo MaaS™</span>
                        </h2>
                    </div>

                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {/* Card 1 */}
                        <div className="bg-white/5 border border-white/10 p-8 rounded-[24px] shadow-xl shadow-black/20 hover:border-secondary/30 hover:bg-white/10 transition-all duration-300 group flex flex-col">
                            <div className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center mb-6 text-secondary group-hover:scale-110 transition-transform">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-2 10h-4v4h-2v-4H7v-2h4V7h2v4h4v2z" /></svg>
                            </div>
                            <h3 className="text-xl font-outfit font-bold text-white mb-6 xl:h-14 lg:h-14">Service Desk Estruturado</h3>
                            <div className="space-y-4 mt-auto">
                                {[
                                    ...
                                    <div key={idx} className="flex items-center gap-3">
                                        ...
                                        <h4 className="text-white font-inter font-medium leading-snug">{item}</h4>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="bg-white/5 border border-white/10 p-8 rounded-[24px] shadow-xl shadow-black/20 hover:border-secondary/30 hover:bg-white/10 transition-all duration-300 group flex flex-col">
                            ...
                            <h3 className="text-xl font-outfit font-bold text-white mb-6 xl:h-14 lg:h-14">Monitoramento Proativo</h3>
                            <div className="space-y-4 mt-auto">
                                {[
                                    "Infraestrutura e serviços críticos",
                        ...
                        <div className="bg-white/5 border border-white/10 p-8 rounded-[24px] shadow-xl shadow-black/20 hover:border-secondary/30 hover:bg-white/10 transition-all duration-300 group flex flex-col">
                            ...
                            <h3 className="text-xl font-outfit font-bold text-white mb-6 xl:h-14 lg:h-14">Gestão de Incidentes</h3>
                            <div className="space-y-4 mt-auto">
                                {[
                                    "Processo formal de tratativa",
                                    "RCA documentado",
                        ...
                        <div className="bg-white/5 border border-white/10 p-8 rounded-[24px] shadow-xl shadow-black/20 hover:border-secondary/30 hover:bg-white/10 transition-all duration-300 group flex flex-col">
                            ...
                            <h3 className="text-xl font-outfit font-bold text-white mb-6 xl:h-14 lg:h-14">Governança Operacional</h3>
                            <div className="space-y-4 mt-auto">
                                {[
